...
export const adminRegistration = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ status: 200, msg: appMsg.newUserCreated })
      .end();
  } catch (error) {
    return res
      .status(500)
      .json({ status: 500, msg: appMsg.someWrong, error: error.message });
  }
};
